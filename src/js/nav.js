...
<a href="${p}phones.html" class="side-link ${isActive('phones.html', current) ? 'active' : ''} block py-2.5 uppercase text-[0.68rem] tracking-[0.18em] text-espresso/80 hover:text-terracotta transition-colors border-t border-charcoal/10 border-b border-charcoal/10">Phones</a>
`.trim();
}

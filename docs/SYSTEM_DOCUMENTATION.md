...
| `node --test` | Node's built-in test runner — no Jest/Mocha/Vitest. 259 tests across 30 `*.test.js` files (current count — see §14 for the authoritative figure) |
...
- **Current count:** 259 tests across 30 test files, 100% passing at last recorded run.
